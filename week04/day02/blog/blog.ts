...
let blogpost1 = new BlogPost('Dani Zsin', 'My life in nutshell', 'Pokemon theme song: \'I wanna be the very best like noone ever was, to catch them is my real test!\'', '2002.05.23');
console.log(blog1.deleteBlogPost(2));
console.log(blog1.deleteBlogPost(4));
console.log(blog1.updateBlogPost(1, blogpost1));
