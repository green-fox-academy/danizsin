...
test('max of three: last', function (t: any): any {
...
test('median: ten', function (t: any): any {
  t.equal(median([7, 5, 3, 5, 6, 90, 120, 67, 32, 65]), 48);
  t.end();
});
...
test('translate: lagopus', function (t: any): any {
  t.equal(translate('laguopus'), 'lavaguvuovopuvus');
  t.end();
});